...
public class OrdersRecord extends UpdatableRecordImpl<OrdersRecord> implements Record6<ULong, String, OrdersOrder, UInteger, Double, Boolean> {
    ...
    @Override
    public Row6<ULong, String, OrdersOrder, UInteger, Double, Boolean> valuesRow() {
    ...
    @Override
    public OrdersRecord values(ULong value1, String value2, OrdersOrder value3, UInteger value4, Double value5, Boolean value6) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public OrdersRecord(ULong id, String name, OrdersOrder order, UInteger quantity, Double price, Boolean ispending) {
        super(Orders.ORDERS);
